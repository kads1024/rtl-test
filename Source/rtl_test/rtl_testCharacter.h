...
#include "rtl_testCharacter.generated.h"

UCLASS(config=Game)
class Artl_testCharacter : public ACharacter, public IDamageable
{
	GENERATED_BODY()
...
public: 
	void OnDamage_Implementation(float p_amount) override;
